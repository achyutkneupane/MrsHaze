    ...
    <div class='flex flex-col w-full gap-4 md:flex-row'>
        ...
        <div class='w-full md:w-1/2'>
            <div class="flex flex-col w-full gap-4 p-4 bg-white border rounded shadow-sm">
                ...
                <div class="flex flex-col w-full gap-2">
                    <button class='w-full p-2 font-bold text-white uppercase border rounded-lg border-turq hover:text-black bg-turq hover:border-black' wire:click='publishSong'>Publish</button>
